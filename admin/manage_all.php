    ...
    <div class="container">
        ...
        <section class="hurts_table">
            <div class="container">
                ...
                <p><a href="http://kkk234454.duckdns.org/phpmyadmin" target="_blank">phpmyadmin으로 이동 <i class="fas fa-angle-right"></i></a> | <a href="manage.php">미발송 대기자 명단 표시 <i class="fas fa-angle-right"></i></a></p>
                <br/>
